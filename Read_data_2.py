...
X_rest, X_cv1, y_rest, y_cv1 =  train_test_split(X, y, test_size=1/5, random_state=seed)

X_rest, X_cv2, y_rest, y_cv2 =  train_test_split(X_rest, y_rest, test_size=1/4, random_state=seed)

X_rest, X_cv3, y_rest, y_cv3 =  train_test_split(X_rest, y_rest, test_size=1/3 , random_state=seed)

X_cv5, X_cv4, y_cv5, y_cv4 =  train_test_split(X_rest, y_rest, test_size=1/2 , random_state=seed)
