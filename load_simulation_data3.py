...
for random_seed in seed_pool:
    ...
    beta=np.array([4.5,4.5,4.5,4.5,4.5,4.5,4.5,4.5])

    np.random.seed(random_seed)
    cordataY=np.dot(cordataX, beta)+np.random.normal(0,10,num_samples)
...
np.savetxt('OSCAR_MSE_log3.txt', OSCAR_MSE_log)

np.savetxt('Lasso_MSE_log3.txt', Lasso_MSE_log)

np.savetxt('Elastic_net_MSE_log3.txt', Elastic_net_MSE_log)

np.savetxt('OSCAR_df_log3.txt', OSCAR_df_log)

np.savetxt('Lasso_df_log3.txt', Lasso_df_log)

np.savetxt('Elastic_net_df_log3.txt', Elastic_net_df_log)

np.savetxt('clf_MSE_log3.txt', clf_MSE_log)

np.savetxt('clf_df_log3.txt', clf_df_log)
